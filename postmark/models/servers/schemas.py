...
class Server(BaseModel):
    ...
    inbound_hook_url: str | None = Field(None, alias="InboundHookUrl")
    bounce_hook_url: str | None = Field(None, alias="BounceHookUrl")
    open_hook_url: str | None = Field(None, alias="OpenHookUrl")
    delivery_hook_url: str | None = Field(None, alias="DeliveryHookUrl")
    post_first_open_only: bool = Field(alias="PostFirstOpenOnly")
    inbound_domain: str | None = Field(None, alias="InboundDomain")
    ...
    click_hook_url: str | None = Field(None, alias="ClickHookUrl")
